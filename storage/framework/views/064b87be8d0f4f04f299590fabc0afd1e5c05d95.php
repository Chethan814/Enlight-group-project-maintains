        ...
        <div thumbsSlider="" class="swiper university__slider__thumb">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img loading="lazy" src="<?php echo e(asset('assets/img/herobanner/bg-1.jpg')); ?>" />
                </div>
                <div class="swiper-slide">
                    <img loading="lazy" src="<?php echo e(asset('assets/img/herobanner/bg-2.jpg')); ?>" />
                </div>
                <div class="swiper-slide">
                    <img loading="lazy" src="<?php echo e(asset('assets/img/herobanner/bg-3.jpg')); ?>" />
                </div>
            </div>
        </div>
...
<input type='button' style='padding-left:10px;padding-top:10px;padding-right:10px;padding-bottom:10px;margin-left:10px;margin-top:10px;margin-right:10px;margin-bottom:10px;background-color:#bb1b3b;color:#FFFFFF;border-left-width:1px;border-top-width:1px;border-right-width:1px;border-bottom-width:1px;border-color:#d5d5d5;border-radius:5px;cursor:pointer' value='Download Holiday Notification' onMouseOver=this.style.backgroundColor='#FFFFFF';this.style.color='#1b90bb';this.style.borderColor='#d5d5d5' onMouseOut=this.style.backgroundColor='#bb1b3b';this.style.color='#FFFFFF';this.style.borderColor='#d5d5d5' />
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6" data-aos="fade-up">
                    <div class="blogarea__content__wraper__scroll">
                        ...
                        <div class="blogarea__content__wraper">
                            <?php $__currentLoopData = $news; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $newsVal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="blogarea__text__wraper">
                                ...
                                <div class="blogarea__para">
                                    <p><?php echo e($newsVal->news); ?></p>
                                    <p class="align-items-center d-flex gap-2"><span><i class="icofont-calendar text-primary"></i></span><?php echo e($newsVal->publishDate); ?></p>
                                </div>
                            </div>
                ...
                <div class="col-xl-6 col-lg-6" data-aos="fade-up">
                    <div class="blogarea__content__wraper__scroll">
                        ...
                        <div class="blogarea__content__wraper">
                            <?php $__currentLoopData = $notice; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $noticeVal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="blogarea__text__wraper">
                                <div class="blogarea__img new-gif-size">
                                    <div class="blogarea__date">
                                        <img src="<?php echo e(asset('assets/img/newgif.gif')); ?>" alt="new-notice-image">
                                    </div>
                                </div>
                                <div class="blogarea__para">
                                    <p><?php echo e($noticeVal->notice); ?></p>
                                    <p class="align-items-center d-flex gap-2"><span><i class="icofont-calendar text-primary"></i></span><?php echo e($noticeVal->publishDate); ?></p>
                                </div>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="container-fluid full__width__padding">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12" data-aos="fade-up">
                    <div class="single__blog__wraper">
                        <div class="single__blog__img">
                            <img loading="lazy" src="<?php echo e(asset('assets/img/courses/course-6.jpg')); ?>" alt="Institute">
                        </div>
                        <div class="single__blog__content">
                            <p>Enlight Group of Institutions</p>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12" data-aos="fade-up">
                    <div class="single__blog__wraper">
                        <div class="single__blog__img">
                            <img loading="lazy" src="<?php echo e(asset('assets/img/courses/course-7.jpg')); ?>" alt="Institute">
                        </div>
                        <div class="single__blog__content">
                            <p>Enlight Group of Institutions</p>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12" data-aos="fade-up">
                    <div class="single__blog__wraper">
                        <div class="single__blog__img">
                            <img loading="lazy" src="<?php echo e(asset('assets/img/courses/course-8.jpg')); ?>" alt="Institute">
                        </div>
                        <div class="single__blog__content">
                            <p>Enlight Group of Institutions</p>
                ...
                <div class="swiper featured__course">
                    <div class="swiper-wrapper">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                            <div class="gridarea__wraper">
                                <div class="gridarea__img">
                                    <a href="/bScNursing"><img loading="lazy" src="<?php echo e(asset('assets/img/courses/course-1.jpg')); ?>" alt="grid"></a>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                            <div class="gridarea__wraper">
                                <div class="gridarea__img">
                                    <a href="/MSCNursing"><img loading="lazy" src="<?php echo e(asset('assets/img/courses/course-2.jpg')); ?>" alt="grid"></a>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                            <div class="gridarea__wraper">
                                <div class="gridarea__img">
                                    <a href="/diploma-in-medical-laboratory-technology-dmlt"><img loading="lazy" src="<?php echo e(asset('assets/img/courses/course-3.jpg')); ?>" alt="grid"></a>
                                    <div class="gridarea__small__button">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                            <div class="gridarea__wraper">
                                <div class="gridarea__img">
                                    <a href="/diploma-in-medical-imaging-x-ray-technology-dmxt"><img loading="lazy" src="<?php echo e(asset('assets/img/courses/course-4.jpg')); ?>" alt="grid"></a>
                                    <div class="gridarea__small__button gridarea__small__button__1">
                                        <div class="grid__badge blue__color">Paramedical</div>
                                    </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                            <div class="gridarea__wraper">
                                <div class="gridarea__img">
                                    <a href="/PbbscNursing"><img loading="lazy" src="<?php echo e(asset('assets/img/courses/course-5.jpg')); ?>" alt="grid"></a>
                                    <div class="gridarea__small__button gridarea__small__button__1">
                                        <div class="grid__badge">Nursing</div>
                                    </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                            <div class="gridarea__wraper">
                                <div class="gridarea__img">
                                    <a href="/GnmNursing"><img loading="lazy" src="<?php echo e(asset('assets/img/courses/course-6.jpg')); ?>" alt="grid"></a>
                                    <div class="gridarea__small__button gridarea__small__button__1">
                                        <div class="grid__badge">Nursing</div>
                                    </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                            <div class="gridarea__wraper">
                                <div class="gridarea__img">
                                    <a href="/diploma-in-medical-operation-technology-dmot"><img loading="lazy" src="<?php echo e(asset('assets/img/courses/course-7.jpg')); ?>" alt="grid"></a>
                                    <div class="gridarea__small__button gridarea__small__button__1">
                                        <div class="grid__badge blue__color">Paramedical</div>
                                    </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                            <div class="gridarea__wraper">
                                <div class="gridarea__img">
                                    <a href="/diploma-in-medical-anesthesia-technology-dot-dat"><img loading="lazy" src="<?php echo e(asset('assets/img/courses/course-8.jpg')); ?>" alt="grid"></a>
                                    <div class="gridarea__small__button gridarea__small__button__1">
                                        <div class="grid__badge blue__color">Paramedical</div>
                                    </div>
    ...
    <!-- <div class="registerarea sp_top_90">
                                ...
                                <div class="registerarea__video">
                                    <div class="video__pop__btn">
                                        <a class="video-btn" href="https://www.youtube.com/watch?v=vHdclsdkp28"> <img
                                                loading="lazy" src="<?php echo e(asset('assets/img/icon/video.png')); ?>" alt=""></a>
                                    </div>
            ...
            <div class="registerarea__img">
                <img loading="lazy" class="register__1" src="<?php echo e(asset('assets/img/register/register__1.png')); ?>" alt="register">
                <img loading="lazy" class="register__2" src="<?php echo e(asset('assets/img/register/register__2.png')); ?>" alt="register">
                <img loading="lazy" class="register__3" src="<?php echo e(asset('assets/img/register/register__3.png')); ?>" alt="register">
            </div>
        </div> -->
                ...
                <!-- <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                        <div class="about__right__wraper__2 about__right__wraper__4">
                            <div class="educationarea__img" data-tilt="" style="will-change: transform; transform: perspective(2000px) rotateX(0deg) rotateY(0deg);">
                                <img loading="lazy" class="aboutimg__4__img__1" src="<?php echo e(asset('assets/img/about/about_12.png')); ?>" alt="about">
                            </div>
            ...
            <div class="row row__custom__class testimonial__slider__active default__arrow" data-aos="fade-up">
                    ...
                    <div class="single__testimonial__wraper">
                        <div class="single__testimonial__inner">
                            <div class="testimonial__img">
                                <img loading="lazy" src="<?php echo e(asset('assets/img/testimonial/student-1.jpg')); ?>" alt="student-photo" height="60" class="rounded-circle">
                ...
                <div class="col-xl-6 column__custom__class">
                    <div class="single__testimonial__wraper">
                        <div class="single__testimonial__inner">
                            <div class="testimonial__img">
                                <img loading="lazy" src="<?php echo e(asset('assets/img/testimonial/student-2.jpg')); ?>" alt="student-photo" height="60" class="rounded-circle">
                                <div class="testimonial__name">
                                    <h6>Megha Dey</h6>
                                    <span>Tripura</span>
                                </div>
                ...
                <div class="col-xl-6 column__custom__class">
                    <div class="single__testimonial__wraper">
                        <div class="single__testimonial__inner">
                            <div class="testimonial__img">
                                <img loading="lazy" src="<?php echo e(asset('assets/img/testimonial/student-3.jpg')); ?>" alt="student-photo" height="60" class="rounded-circle">
                                <div class="testimonial__name">
                                    <h6>Mitan Das</h6>
                                    <span>Tripura</span>
                                </div>
                ...
                <div class="col-xl-6 column__custom__class">
                    <div class="single__testimonial__wraper">
                        <div class="single__testimonial__inner">
                            <div class="testimonial__img">
                                <img loading="lazy" src="<?php echo e(asset('assets/img/testimonial/student-4.jpg')); ?>" alt="student-photo" height="60" class="rounded-circle">
                                <div class="testimonial__name">
                                    <h6>Susmita Roy</h6>
                                    <span>Tripura</span>
                                </div>
                ...
                <div class="col-xl-6 column__custom__class">
                    <div class="single__testimonial__wraper">
                        <div class="single__testimonial__inner">
                            <div class="testimonial__img">
                                <img loading="lazy" src="<?php echo e(asset('assets/img/testimonial/student-5.jpg')); ?>" alt="student-photo" height="60" class="rounded-circle">
                                <div class="testimonial__name">
            ...
            <div class="row">
                <div class="brandarea__wraper" data-aos="fade-up">
                    <div class="brandarea__img">
                        <a href="javascript:void(0);" class="pe-none"><img loading="lazy" src="<?php echo e(asset('assets/img/brand/partner-1.png')); ?>" alt="brand" height="90"></a>
                    </div>
                    <div class="brandarea__img">
                        <a href="javascript:void(0);" class="pe-none"><img loading="lazy" src="<?php echo e(asset('assets/img/brand/partner-2.png')); ?>" alt="brand" height="90"></a>
                    </div>
                    <div class="brandarea__img">
                        <a href="javascript:void(0);" class="pe-none"><img loading="lazy" src="<?php echo e(asset('assets/img/brand/partner-3.png')); ?>" alt="brand" height="90"></a>
                    </div>
                    <div class="brandarea__img">
                        <a href="javascript:void(0);" class="pe-none"><img loading="lazy" src="<?php echo e(asset('assets/img/brand/partner-4.png')); ?>" alt="brand" height="90"></a>
                    </div>
                    <div class="brandarea__img">
                        <a href="javascript:void(0);" class="pe-none"><img loading="lazy" src="<?php echo e(asset('assets/img/brand/partner-5.png')); ?>" alt="brand" height="90"></a>
                    </div>
                    <div class="brandarea__img">
                        <a href="javascript:void(0);" class="pe-none"><img loading="lazy" src="<?php echo e(asset('assets/img/brand/partner-6.png')); ?>" alt="brand" height="90"></a>
                    </div>
                    <div class="brandarea__img">
                        <a href="javascript:void(0);" class="pe-none"><img loading="lazy" src="<?php echo e(asset('assets/img/brand/partner-7.png')); ?>" alt="brand" height="90"></a>
                    </div>
                    <div class="brandarea__img">
                        <a href="javascript:void(0);" class="pe-none"><img loading="lazy" src="<?php echo e(asset('assets/img/brand/partner-8.png')); ?>" alt="brand" height="90"></a>
                    </div>
                    <div class="brandarea__img">
                        <a href="javascript:void(0);" class="pe-none"><img loading="lazy" src="<?php echo e(asset('assets/img/brand/partner-9.png')); ?>" alt="brand" height="90"></a>
                    </div>
                    <div class="brandarea__img">
                        <a href="javascript:void(0);" class="pe-none"><img loading="lazy" src="<?php echo e(asset('assets/img/brand/partner-10.png')); ?>" alt="brand" height="90"></a>
                    </div>
                    <div class="brandarea__img">
                        <a href="javascript:void(0);" class="pe-none"><img loading="lazy" src="<?php echo e(asset('assets/img/brand/partner-11.png')); ?>" alt="brand" height="90"></a>
                    </div>
                    <div class="brandarea__img">
                        <a href="javascript:void(0);" class="pe-none"><img loading="lazy" src="<?php echo e(asset('assets/img/brand/partner-12.png')); ?>" alt="brand" height="90"></a>
                    </div>
                    <div class="brandarea__img">
                        <a href="javascript:void(0);" class="pe-none"><img loading="lazy" src="<?php echo e(asset('assets/img/brand/partner-13.png')); ?>" alt="brand" height="90"></a>
                    </div>
                    <div class="brandarea__img">
                        <a href="javascript:void(0);" class="pe-none"><img loading="lazy" src="<?php echo e(asset('assets/img/brand/partner-14.png')); ?>" alt="brand" height="90"></a>
                    </div>
                    <div class="brandarea__img">
                        <a href="javascript:void(0);" class="pe-none"><img loading="lazy" src="<?php echo e(asset('assets/img/brand/partner-15.png')); ?>" alt="brand" height="90"></a>
                    </div>
                </div>
            </div>
            ...
            <div class="blogsidebar__content__wraper__2">
                ...
                <div class="photo__gallery__img">
                    ...
                    <div class="single__gallery__img">
                        <img loading="lazy" src="<?php echo e(asset('assets/img/gallery/gallery-1.jpg')); ?>" alt="photo">
                        <div class="gallery__icon">
                            <a class="popup__img" href="<?php echo e(asset('assets/img/gallery/gallery-1.jpg')); ?>"> <i class="icofont-eye-alt"></i></a>
                        </div>
                    </div>
                    <div class="single__gallery__img">
                        <img loading="lazy" src="<?php echo e(asset('assets/img/gallery/gallery-2.jpg')); ?>" alt="photo">
                        <div class="gallery__icon">
                            <a class="popup__img" href="<?php echo e(asset('assets/img/gallery/gallery-2.jpg')); ?>"> <i class="icofont-eye-alt"></i></a>
                        </div>
                    </div>
                    <div class="single__gallery__img">
                        <img loading="lazy" src="<?php echo e(asset('assets/img/gallery/gallery-3.jpg')); ?>" alt="photo">
                        <div class="gallery__icon">
                            <a class="popup__img" href="<?php echo e(asset('assets/img/gallery/gallery-3.jpg')); ?>"> <i class="icofont-eye-alt"></i></a>
                        </div>
                    </div>
                    <div class="single__gallery__img">
                        <img loading="lazy" src="<?php echo e(asset('assets/img/gallery/gallery-4.jpg')); ?>" alt="photo">
                        <div class="gallery__icon">
                            <a class="popup__img" href="<?php echo e(asset('assets/img/gallery/gallery-4.jpg')); ?>"> <i class="icofont-eye-alt"></i></a>
                        </div>
                    </div>
                    <div class="single__gallery__img">
                        <img loading="lazy" src="<?php echo e(asset('assets/img/gallery/gallery-5.jpg')); ?>" alt="photo">
                        <div class="gallery__icon">
                            <a class="popup__img" href="<?php echo e(asset('assets/img/gallery/gallery-5.jpg')); ?>"> <i class="icofont-eye-alt"></i></a>
                        </div>
                    </div>
                    <div class="single__gallery__img">
                        <img loading="lazy" src="<?php echo e(asset('assets/img/gallery/gallery-6.jpg')); ?>" alt="photo">
                        <div class="gallery__icon">
                            <a class="popup__img" href="<?php echo e(asset('assets/img/gallery/gallery-6.jpg')); ?>"> <i class="icofont-eye-alt"></i></a>
                        </div>
                    </div>

                    <div class="single__gallery__img">
                        <img loading="lazy" src="<?php echo e(asset('assets/img/gallery/gallery-7.jpg')); ?>" alt="photo">
                        <div class="gallery__icon">
                            <a class="popup__img" href="<?php echo e(asset('assets/img/gallery/gallery-7.jpg')); ?>"> <i class="icofont-eye-alt"></i></a>
                        </div>
                    </div>
                    <div class="single__gallery__img">
                        <img loading="lazy" src="<?php echo e(asset('assets/img/gallery/gallery-8.jpg')); ?>" alt="photo">
                        <div class="gallery__icon">
                            <a class="popup__img" href="<?php echo e(asset('assets/img/gallery/gallery-8.jpg')); ?>"> <i class="icofont-eye-alt"></i></a>
                        </div>
                    </div>
