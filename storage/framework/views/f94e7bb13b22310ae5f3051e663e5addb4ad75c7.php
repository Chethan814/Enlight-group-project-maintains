...
<div class="breadcrumbarea" style="background-image: url('<?php echo e(asset('assets/img/infobanner/infobanner-7.jpg')); ?>')">
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6" data-aos="fade-up">
                <div class="aboutarea__5__img" data-tilt="" style="will-change: transform; transform: perspective(2000px) rotateX(0deg) rotateY(0deg);">
                    <img loading="lazy" src="<?php echo e(asset('assets/img/about/chairman.jpg')); ?>" alt="about">
                </div>
            </div>
...
<?php echo $__env->make('WebView.WebViewLayouts.WebViewLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\cheth\OneDrive\Desktop\projects\Freelancing work\Enlight\Current-working-file\enlight_website\resources\views/WebView/About/ChairmanMessage.blade.php ENDPATH**/ ?>