...
<head>
    ...
    <title>Enlight Group of Institutions – Official Website of Enlight Group</title>

    <!-- <link rel="shortcut icon" type="image/x-icon" href="img/favicon.ico"> -->
    <link rel="icon" href="<?php echo e(asset('cropped-Logo-32x32.png')); ?>" sizes="32x32" />
    <link rel="icon" href="<?php echo e(asset('cropped-Logo-180x180.png')); ?>" sizes="192x192" />
    <link rel="apple-touch-icon" href="<?php echo e(asset('cropped-Logo-192x192')); ?>" />
...
<body>
    ...
    <div id="back__preloader">
        ...
        <div class="back__loader_logo">
            <img loading="lazy" src="<?php echo e(asset('cropped-Logo-180x180.png')); ?>" alt="Preload">
        </div>
    </div>
    <!-- pre loader area end -->
    ...
    <main class="main_wrapper overflow-hidden">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="topbar__left">
                            <ul>
                                ...
                                <li>
                                    <i class="icofont-email ms-2"></i> infoenlightnursing@gmail.com
                                </li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <ul>
                                    <li>
                                        <a title="Facebook" target="_blank"
                                            href="https://www.facebook.com/sovamjamatiaofficial"><i
                                ...
                                <div class="headerarea__left">
                                    <div class="headerarea__left__logo">
                                        ...
                                        <a href="/"><img loading="lazy"
                                                src="<?php echo e(asset('assets/img/logo/enlight-group-logo.png')); ?>" alt="logo"
                                                class="main-logo"></a>
                                    </div>
                            ...
                            <div class="col-6">
                                <div class="mobile-logo">
                                    <a class="logo__dark" href="#"><img loading="lazy"
                                            src="<?php echo e(asset('assets/img/logo/enlight-group-logo.png')); ?>" height="60"
                                            alt="logo"></a>
                                </div>
                            </div>
                            <div class="col-6">
        ...
        <div class="content">
            <?php echo $__env->yieldContent('webContent'); ?>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-3">
                            <div class="footerarea__icon footerarea__icon__2">
                                <ul>
                                    <li><a title="Facebook" href="https://www.facebook.com/sovamjamatiaofficial"
