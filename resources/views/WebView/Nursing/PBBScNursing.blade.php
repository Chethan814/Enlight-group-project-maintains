                ...
                <div class="col-xl-8 col-lg-8">
                    ...
                    <div class="blog__details__content__wraper">
                        ...
                        <div class="course__details__paragraph text-justify" data-aos="fade-up">
                            <p>The B.Sc Nursing (Post certificate) course of study shall extend over a period of 2 academic
                                years from the date of commencement of his/ her study of the subjects. Terms and vacations
                                shall be as notified by the university from time to time.
                            </p>
                        </div>
                        ...
                        <div class="blogsidebar__content__wraper__2" data-aos="fade-up">
                            ...
                            <ul class="course__details__populer__list">
                                ...
                                <li>
                                    ...
                                    <div class="course__details__populer__img">
                                        <img loading="lazy" src="{{ asset('assets/img/courses/course-2.jpg')}}"
                                            alt="courses" width="90" height="70">
                                    </div>
                                    <div class="course__details__populer__content">
                                        <h6>
