                    ...
                    <div class="about__right__wraper__2">
                        <div class="educationarea__img" data-tilt>
                            <img loading="lazy" class="aboutarea__2__img__1" width="520vw" height="460vh"
                                src="{{asset('assets/img/about/Updated-images/Enlight-Clg.jpg')}}" alt="College photo">
        ...
        <div class="container-fluid full__width__padding">
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12" data-aos="fade-up">
                    <div class="single__blog__wraper">
                        <div class="single__blog__img">
                            <img loading="lazy" src="{{asset('assets/img/courses/updated-image/course-4.jpg')}}" alt="Institute">
                        </div>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12" data-aos="fade-up">
                    <div class="single__blog__wraper">
                        <div class="single__blog__img">
                            <img loading="lazy" src="{{asset('assets/img/courses/updated-image/course-2.jpg')}}"
                                alt="Institute">
                        </div>
                        <div class="single__blog__content">
                            <p>Enlight Group of Institutions</p>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12" data-aos="fade-up">
                    <div class="single__blog__wraper">
                        <div class="single__blog__img">
                            <img loading="lazy" src="{{asset('assets/img/courses/updated-image/course-3.jpg')}}"
                                alt="Institute">
                        </div>
                        <div class="single__blog__content">
                            <p>Enlight Group of Institutions</p>
